...
hist(felicidad,ylab = "frecuencia",main="Histograma de la variable felicidad")
...
Al mirar este gráfico, esto es lo que deberías interpretar: la línea gruesa en el medio de la caja es la mediana; la caja en sí abarca desde el percentil 25 hasta el 75; y los "bigotes" cubren todo el rango desde el valor mínimo hasta el máximo. Puedes observarlo en la Figura @fig-boxplotanotado.
