...
¿El *r* de Pearson **siempre** queda entre –1 y 1, sin importar qué datos uses? Sí. Mirá la siguiente simulación. Reordenamos al azar los números del 1 al 10 para una variable X, y lo mismo para Y. Calculamos el *r* de Pearson y repetimos eso 1000 veces. Como podés ver en la figura @fig-3onethousandr, **todos** los puntos caen entre –1 y 1. Tremendo, ¿no?
...
La **pendiente** indica la inclinación de la línea, y el **intercepto** o la **intersección con el eje y** es el punto donde la línea cruza el eje vertical. Miremos las líneas de la figura @fig-3twolines.
...
Genial. Ahora podemos verificar si lo hicimos bien. Vamos a graficar los datos en un diagrama de dispersión y trazar una línea con pendiente = 1.19 y una intersección en el eje y de –0.221. Como se muestra en la figura @fig-3corwithLine, la línea debería atravesar el centro de los puntos.
