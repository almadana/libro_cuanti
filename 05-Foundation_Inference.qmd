...
Gracias. Acá va la traducción fiel del bloque `fig-5unifagain`, incluyendo el código R y el texto que lo acompaña:
...
¡Felicitaciones para nosotrxs! Acabamos de hacer inferencias estadísticas sin usar fórmulas.
...
Podés ver el cambio en la medición entre condiciones, es tan obvio como el día y la noche. Entonces, cuando realizás una manipulación y **ves la diferencia** (el cambio) en tu medición, podés estar bastante segurx de que tu manipulación **está causando el cambio**.
