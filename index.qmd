...
-   website: <https://almadana.github.io/libro_cuanti/>
-   Github: <https://github.com/almadana/libro_cuanti>

### Sitios asociados al curso de Cuanti

-   EVA: <https://eva-cursos.psico.edu.uy/>
-   Lecciones: <https://almadana.github.io/lecciones_cuanti/>
-   Repo Lecciones: <https://github.com/almadana/lecciones_cuanti/>
-   Prácticos: <https://almadana.github.io/practicos_cuanti/>
-   Repo prácticos: <https://github.com/CrumpLab/psyc3400>

Todos los recursos están bajo licencia Creative Commons [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). Haz click para leer más sobre la licencia, o lee más abajo en la sección de licencia.

### Contribuyentes

Traducción: ChatGPT-4o. Supervisión: Álvaro Cabana Nuevos capítulos: ChatGPT-4o. Supervisión: Álvaro Cabana Adendas: Clementina Tomás, Emilia Flo
